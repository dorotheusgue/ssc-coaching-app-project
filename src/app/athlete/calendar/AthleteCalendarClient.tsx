...
const blockTypeColors: Record<string, string> = {
 warmup: "bg-ink/10 border-line text-ink",
 sprint: "bg-ink/10 border-line text-ink",
 strength: "bg-ink/10 border-line text-ink",
 accessory: "bg-ink/10 border-line text-ink",
...
function statusIcon(status: string) {
 switch (status) {
 case "completed":
 return <CheckCircle2 className="w-4 h-4 text-ink" />;
 case "in_progress":
 return <Clock className="w-4 h-4 text-ink" />;
 case "skipped":
...
export default function AthleteCalendarClient({
 ...
 <div className="flex gap-1 bg-surface border border-line p-1">
 <button
 ...
 className="w-full flex items-center gap-1 text-xs text-left hover:bg-hover/50 px-1 py-0.5 -mx-1 transition-colors cursor-pointer"
 >
 {statusIcon(s.status)}
 ...
 <CheckCircle2 className="w-3 h-3 text-ink" /> Completed
 </div>
 <div className="flex items-center gap-1">
 <Clock className="w-3 h-3 text-ink" /> In Progress
 </div>
 <div className="flex items-center gap-1">
 ...
 <div
 key={b.id}
 className={`border p-3 ${blockTypeColors[b.blockType] ?? "bg-surface/30 border-line text-ink"}`}
 >
 ...
 className="flex-1 bg-bg border border-line px-3 py-2 text-ink text-sm focus:outline-none focus:ring-2 focus:ring-ink"
 />
 <Button
 size="sm"
 variant="secondary"
...
function SessionRow({
 ...
 className="w-full flex items-center gap-3 p-3 bg-surface border border-line hover:border-line hover:bg-hover transition-colors text-left cursor-pointer"
 >
