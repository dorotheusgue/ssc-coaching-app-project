      ...
      <div className="bg-surface rounded-xl border border-line p-6">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full bg-surface border border-line rounded-lg px-3 py-2 text-ink text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          />
          <label className="flex items-center justify-center gap-2 w-full p-4 border-2 border-dashed border-line rounded-lg cursor-pointer hover:border-emerald-500 transition-colors">
        ...
        <div className="grid grid-cols-2 gap-4">
          {items.map((item) => (
            <button
              ...
              className="bg-surface rounded-xl border border-line overflow-hidden hover:border-line transition-colors text-left"
            >
