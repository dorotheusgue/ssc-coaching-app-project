...
export default async function DashboardPage() {
 ...
 <div className={`p-3 bg-surface/50 ${kpi.color}`}>
 ...
 <div className="flex items-center gap-3 p-3 bg-surface/50 hover:bg-hover transition-colors">
...
function NewProgramQuickAction() {
 ...
 <button
 type="submit"
 className="w-full flex items-center gap-3 p-3 bg-surface/50 hover:bg-hover transition-colors text-left"
 >
 <div className="p-2 bg-ink/10">
 <Dumbbell className="w-4 h-4 text-ink" />
 </div>
 <div>
