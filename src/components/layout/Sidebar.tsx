    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-line space-y-2">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-mute hover:bg-hover hover:text-ink transition-colors cursor-pointer"
        >
  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2 rounded-lg bg-surface text-ink border border-line cursor-pointer"
      >
